...
struct scm_tjit_state
{
  ...
  SCM parent_fragment_id;   /* fragment ID of parent trace, or 0 for root */
  SCM parent_exit_id;       /* exit id of parent trace, or 0 for root */
...
SCM_API SCM scm_do_i_string_ref (SCM str, size_t idx);
